...
class TreatmentBoundaryOverlaySnapshotRef(BaseModel):
    ...
    host_surface_authority_sha256: str = Field(pattern=r'^[0-9a-f]{64}    model_config = ConfigDict(frozen=True, extra='forbid')
...
class AcousticSceneSnapshot(BaseModel):
    ...
    material_boundary_configuration_sha256: str = Field(
        pattern=r'^[0-9a-f]{64}    receivers: tuple[AcousticReceiverBinding, ...]
...
def build_acoustic_prediction_request(
    *,
    ...
    treatment_definition_hash_sha256: str = Field(pattern=r'^[0-9a-f]{64}    model_config = ConfigDict(frozen=True, extra='forbid')
...
def build_acoustic_prediction_request(
    *,
    ...
    treatment_placement_hash_sha256: str = Field(pattern=r'^[0-9a-f]{64}    model_config = ConfigDict(frozen=True, extra='forbid')
...
def build_acoustic_prediction_request(
    *,
    ...
    surface_binding_evaluation_id: str = Field(
        pattern=r'^treatment-surface-binding:[0-9a-f]{64}    model_config = ConfigDict(frozen=True, extra='forbid')
...
def build_acoustic_prediction_request(
    *,
    ...
    surface_binding_evaluation_hash_sha256: str = Field(pattern=r'^[0-9a-f]{64}    model_config = ConfigDict(frozen=True, extra='forbid')
...
class TreatmentBoundarySnapshotBinding(BaseModel):
    ...
    host_surface_id: str = Field(pattern=r'^semantic-surface:[0-9a-f]{64}    model_config = ConfigDict(frozen=True, extra='forbid')
...
def build_acoustic_prediction_request(
    *,
    ...
    composition_id: str | None = Field(
        default=None,
        pattern=r'^treatment-boundary-composition:[0-9a-f]{64}    model_config = ConfigDict(frozen=True, extra='forbid')
...
,
    ...
    composition_hash_sha256: str | None = Field(
        default=None,
        pattern=r'^[0-9a-f]{64}    model_config = ConfigDict(frozen=True, extra='forbid')
