...
| 次工程 | **R100BはMFEM concave/impedance independent reference、pyroom stochastic-seed/convergence、concave/portal/obstacle等の残gateへ進む。#151 native impedance PASSだけでproduction solverを選定しない。O90はO90C以降を別sliceとして進め、O100はR110 interface確定までO100C source authorityを先走らない。Issue #83 owned-room gateも未完了** |
