...
7. PFFDTD exact-concave/spatial evidence: **Issue #179 in progress**. Concave geometry must remain exact; the current MFEM concave reference is FAIL and cannot be promoted to truth. Spatial incident/reflected extraction remains BLOCKED until solver-neutral decomposition authority exists;
